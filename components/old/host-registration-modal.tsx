...
export default function HostRegistrationModal({ isOpen, onClose }: HostRegistrationModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    console.log("[v0] Host registration submitted:", formData)
    setSubmitted(true)
    setLoading(false)
          ...
          {submitted ? (
            <div className="flex flex-col items-center justify-center py-8">
              ...
              <p className="text-white/60 text-center text-sm">
                We'll be in touch soon. Earn passive income by listing your storage space.
              </p>
            </div>
          ) : (
            <form onSubmit={handleSubmit} className="space-y-4">
              <p className="text-white/70 text-sm mb-6">
                Earn passive income by listing your extra storage space. Help students store smart.
              </p>
