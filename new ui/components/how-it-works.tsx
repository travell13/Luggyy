...
export default function HowItWorks() {
  ...
  return (
    <section className={`py-16 md:py-24 ${theme === "dark" ? "bg-black" : "bg-white"}`}>
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-6">
          {steps.map((step, index) => (
            ...
            >
              <div
                className={`mb-6 flex items-center justify-center h-20 w-20 rounded-full border-2 ${theme === "dark" ? "border-cyan-400" : "border-cyan-600"}`}
                style={{
                  background:
                    theme === "dark"
                      ? "linear-gradient(135deg, rgba(34, 211, 238, 0.1), rgba(255, 92, 40, 0.1))"
                      : "linear-gradient(135deg, rgba(34, 211, 238, 0.2), rgba(255, 92, 40, 0.2))",
                }}
              >
