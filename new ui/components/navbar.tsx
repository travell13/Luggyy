    ...
    >
      <div className="w-[calc(100%-24px)] max-w-[1400px] mt-2">
        ...
        >
          ...
          {/* Mobile Menu Button */}
          <button
            className={`md:hidden flex items-center justify-center mr-2 p-2 rounded-md ${theme === "dark" ? "hover:bg-white/10" : "hover:bg-black/10"} transition-colors`}
        ...
        <div
          className={`fixed top-[76px] right-6 w-[calc(100%-48px)] max-w-[400px] ${theme === "dark" ? "bg-black/20" : "bg-white/60"} backdrop-blur-xl border ${theme === "dark" ? "border-white/15" : "border-black/8"} rounded-[16px] shadow-2xl z-50 transform transition-transform duration-300 ease-in-out ${
        ...
        >
          <div className="p-4 flex flex-col gap-4">
            ...
            <button
              onClick={toggleLanguage}
              className={`${theme === "dark" ? "text-white/80 hover:text-white hover:bg-white/5 border-white/20" : "text-black/80 hover:text-black hover:bg-black/5 border-black/20"} transition-colors text-left py-3 px-4 rounded-lg border`}
              style={{
                fontFamily:
                  'GeistMono, ui-monospace, SFMono-Regular, "Roboto Mono", Menlo, Monaco, "Liberation Mono", "DejaVu Sans Mono", "Courier New", monospace',
              }}
