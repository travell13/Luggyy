    ...
    >
      ...
      <div className="max-w-[1920px] mx-auto relative px-6 md:px-8">
        <section
          ...
          className={`relative mb-6 md:h-[calc(100vh-144px)] font-geist flex flex-col transition-all duration-1000 rounded-[16px] overflow-hidden ${heroAnimation.isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            }`}
          style={{
            background:
              theme === "dark"
        ...
        >
          ...
          >
            ...
            <p
              className={`max-w-2xl mx-auto mb-8 transition-colors duration-500 ease-out ${theme === "dark" ? "text-white/80" : "text-black/70"
                }`}
              style={{
                fontFamily:
                  language === "ko"
        ...
        <section
          ...
          className={`py-16 md:py-24 transition-all duration-500 ease-out delay-200 ${campusAnimation.isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            }`}
        >
        ...
        <section
          ...
          className={`relative rounded-[16px] rounded-all-devices mt-6 mb-6 md:h-[calc(100vh-144px)] font-geist flex flex-col transition-all duration-1000 ${ctaAnimation.isVisible ? "opacity-100 scale-100" : "opacity-0 scale-95"
            }`}
        >
          ...
          <div className="relative w-full px-4 sm:px-6 lg:px-8 text-center pt-[38px] sm:pt-[50px] pb-8 md:pt-[70px] md:pb-12 z-10 flex flex-col h-full justify-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
              ...
              <Button
                ...
                className={`font-mono text-sm font-semibold tracking-wider py-3 px-6 rounded-lg hover:opacity-90 transition-all duration-500 ease-out border ${theme === "dark" ? "bg-black text-white border-white/30" : "bg-white text-black border-black/30"
                  }`}
                style={{
                  fontFamily:
                    language === "ko"
        ...
        <section
          ...
          className={`py-16 md:py-24 transition-all duration-500 ease-out delay-300 ${contactAnimation.isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            }`}
        >
